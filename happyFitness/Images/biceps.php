...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|Biceps| HAPPY FITNESS</title>
</head>
  <body>
    ...
    <div>
          <p class="welcome_workouts">Welcome to Biceps section</p>
    </div>
   
      <div class="abs_img">
        <img class="shoulder_img" src="images/biceps1.jpg" alt="biceps workout">
        <img class="shoulder_img" src="images/biceps2.jpg" alt="biceps workout">
        <img class="shoulder_img" src="images/biceps3.jpg" alt="biceps workout">
        <img class="shoulder_img" src="images/biceps4.jpg" alt="biceps workout">
        <img class="shoulder_img" src="images/biceps5.jpg" alt="biceps workout">
        <img class="shoulder_img" src="images/biceps6.jpg" alt="biceps workout">
