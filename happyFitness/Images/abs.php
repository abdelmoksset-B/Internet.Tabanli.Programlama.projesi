...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|Abs| HAPPY FITNESS</title>
</head>
<body>
  ...
  <div>
    <p class="welcome_workouts">Welcome to Abs section</p>
  </div>
  
  <div class="abs_img">
    <img class="workouts_img2" src="images/abs2.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs3.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs4.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs5.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs6.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs7.jpg" alt="abs workout">
  </div>
  
  <div class="abs_img">
    <img class="workouts_img2" src="images/abs8.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs9.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs10.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs11.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs12.jpg" alt="abs workout">
    <img class="workouts_img2" src="images/abs13.jpg" alt="abs workout">
  </div>
