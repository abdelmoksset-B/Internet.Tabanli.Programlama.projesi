...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|Shoulder| HAPPY FITNESS</title>
</head>
  <body>
    ...
    <div>
          <p class="welcome_workouts">Welcome to Shoulder section</p>
    </div>
   
      <div class="abs_img">
        <img class="shoulder_img" src="images/shoulder1.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder2.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder3.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder4.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder5.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder6.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder7.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder8.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder9.jpg" alt="shoulder workout">
        <img class="shoulder_img" src="images/shoulder10.jpg" alt="shoulder workout">
      </div>
