...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|Back| HAPPY FITNESS</title>
</head>
  <body>
    ...
    <div>
          <p class="welcome_workouts">Welcome to back section</p>
    </div>
   
      <div class="abs_img">
        <img class="workouts_img2" src="images/back1.jpg" alt="backworkout">
        <img class="workouts_img2" src="images/back2.jpg" alt="back workout">
        <img class="workouts_img2" src="images/back3.jpg" alt="back workout">
        <img class="workouts_img2" src="images/back4.jpg" alt="back workout">
        <img class="workouts_img2" src="images/back5.jpg" alt="back workout">
        <img class="workouts_img2" src="images/back6.jpg" alt="back workout">
      </div>
