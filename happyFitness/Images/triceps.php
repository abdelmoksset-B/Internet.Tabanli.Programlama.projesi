...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|Triceps| HAPPY FITNESS</title>
</head>
  <body>
    ...
    <div>
          <p class="welcome_workouts">Welcome to Triceps section</p>
    </div>
   
      <div class="abs_img">
        <img class="shoulder_img" src="images/triceps1.jpg" alt="triceps workout">
        <img class="shoulder_img" src="images/triceps2.jpg" alt="triceps workout">
        <img class="shoulder_img" src="images/triceps3.jpg" alt="triceps workout">
        <img class="shoulder_img" src="images/triceps4.jpg" alt="triceps workout">
        <img class="shoulder_img" src="images/triceps5.jpg" alt="triceps workout">
        <img class="shoulder_img" src="images/triceps6.jpg" alt="triceps workout">
