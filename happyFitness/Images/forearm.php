...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Fugaz+One&family=Shrikhand&display=swap" rel="stylesheet">
  ...
  <title>Workouts|forearm| HAPPY FITNESS</title>
</head>
  <body>
    ...
    <div>
          <p class="welcome_workouts">Welcome to Forearm section</p>
    </div>
   
      <div class="abs_img">
        <img class="shoulder_img" src="images/forearm1.jpg" alt="forearm workout">
        <img class="shoulder_img" src="images/forearm2.jpg" alt="forearm workout">
        <img class="shoulder_img" src="images/forearm3.jpg" alt="forearm workout">
        <img class="shoulder_img" src="images/forearm4.jpg" alt="forearm workout">
        <img class="shoulder_img" src="images/forearm5.jpg" alt="forearm workout">
